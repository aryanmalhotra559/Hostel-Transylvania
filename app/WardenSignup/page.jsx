...
import OtpVerification1 from "../otpverify1/page";
...
const WardenSignup = () => {
  ...
  const handleOtpVerified = () => {
    ...
    router.push("/wardenLogin"); // Redirect to login page after OTP verification
  };
    ...
    <div className="flex flex-col justify-center items-center h-screen relative">
      ...
      {showOtp && (
        <div className="absolute left-1/2 transform -translate-x-1/2 bottom-10">
          <OtpVerification1 email={email} onOtpVerified={handleOtpVerified} />
        </div>
      )}
    </div>
  );
